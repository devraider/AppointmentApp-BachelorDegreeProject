<?php
  ...
  $recipient_line=__LINE__;
	...
	$smtp->host_name="smtp.zoho.eu";       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
...
//	$smtp->http_proxy_host_port=465;   /* Change this variable if you need to connect to SMTP server via an HTTP proxy */
	...
	$smtp->user="admin@paulcristea.xyz";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="NOplease11";                 /* Set to the authetication password */
